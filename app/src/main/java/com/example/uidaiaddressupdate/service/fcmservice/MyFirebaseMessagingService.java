...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleInitMessage(Map<String, String> messageData) {
        ...
        try {
            ...
            lenderTransactionsDao.insertTransaction(new LenderTransactions(transactionID, addressRequestMessage.getRenterName(), addressRequestMessage.getRenterNumber(), "init", "", requesterSC));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
