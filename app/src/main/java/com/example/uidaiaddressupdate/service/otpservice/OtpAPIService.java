package com.example.uidaiaddressupdate.service.otpservice;

import com.example.uidaiaddressupdate.service.otpservice.model.Opts;
import com.example.uidaiaddressupdate.service.otpservice.model.Otp;
import com.example.uidaiaddressupdate.service.otpservice.model.OtpRes;
import com.example.uidaiaddressupdate.service.otpservice.model.Type;
import com.example.uidaiaddressupdate.service.otpservice.util.NamespaceFilter;
...
public class OtpAPIService {
    ...
    private Otp createOtpRequest(String aua, String sa, String licenseKey,
                                 String uid, String txn, Type type) throws DatatypeConfigurationException {
        ...
        otpReq.setTs(DatatypeFactory.newInstance().newXMLGregorianCalendar(
...
//        Document signedDocument = sign(inputDocument, includeKeyInfo);
        Document signedDocument = inputDocument;
...
//    }
//
//    private Document sign1(Document xmlDoc, boolean includeKeyInfo) throws Exception {
//
//        // Creating the XMLSignature factory.
//        XMLSignatureFactory fac = XMLSignatureFactory.getInstance("DOM");
//        // Creating the reference object, reading the whole document for
